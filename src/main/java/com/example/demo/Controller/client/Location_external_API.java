...
public class Location_external_API {
    ...
    public static List<costumerAndLocationDTO> getUserLocation(User_Location location) {
        WebClient webClient = WebClient.create();
        
        List<costumerAndLocationDTO> body = webClient.get()
            ...
            .exchangeToMono(resp -> {
                ...
                return resp.bodyToMono(
                    new ParameterizedTypeReference<List<costumerAndLocationDTO>>() {}
                );
            })
            .block();
